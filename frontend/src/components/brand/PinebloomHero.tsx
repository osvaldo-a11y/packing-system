        ...
        className={cn(
          homeDesktop
            ...
            : cn(
                ...
                receptionsDesktop &&
                  'lg:right-0 lg:top-1 lg:h-[124%] lg:w-[680px] lg:max-w-[62%] lg:translate-y-0 lg:object-contain lg:object-right lg:opacity-[0.78] lg:contrast-[0.96] lg:brightness-[1.03] lg:saturate-[0.68]',
