  ...
  return (
    <div
      className={cn(
        ...
        (inventoryPage || repalletPage || packingListsIndex) && 'max-lg:pb-0 max-lg:pt-0 lg:pb-0 lg:pt-0',
      )}
    >
      <div className={cn('mb-6 space-y-3', (inventoryPage || repalletPage || packingListsIndex) && 'hidden')}>
