...
export const processTokens: Record<ProcessSemantic, ProcessTokenClasses> = {
  reception: {
    ...
    iconWell: 'bg-[#BDC6B2] text-[#343A31]',
  ...
  pt: {
    ...
    iconWell: 'bg-[#B4C5CE] text-[#31434B]',
  ...
  stock: {
    ...
    iconWell: 'bg-[#B1C2CC] text-[#45565E]',
  ...
  dispatch: {
    ...
    iconWell: 'bg-[#DBC8A3] text-[#665332]',
  ...
  materials: {
    ...
    iconWell: 'bg-[#BAC4AE] text-[#353A33]',
    stripe: 'border-l-[var(--olive-600)]',
