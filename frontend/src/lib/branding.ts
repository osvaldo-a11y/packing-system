...
export const appBranding: AppBranding = {
  ...
  logoUrl: envLogo?.trim() || '/branding/pinebloom-logo-official.png?v=fid1',
  logoFullUrl: '/branding/pinebloom-logo-official.png?v=fid1',
  logoOfficialUrl: '/branding/pinebloom-logo-official.png?v=fid1',
  logoSidebarUrl: '/branding/pinebloom-logo-sidebar.png?v=fid1',
  logoMobileUrl: '/branding/pinebloom-logo-official.png?v=fid1',
  ...
  watermarkUrl: '/branding/pinebloom-field-hero.png?v=fid1',
  landscapeUrl: '/branding/pinebloom-field-hero.png?v=fid1',
