...
export const appBranding: AppBranding = {
  ...
  logoUrl: envLogo?.trim() || '/branding/pinebloom-logo-official.png?v=home2',
  logoFullUrl: '/branding/pinebloom-logo-official.png?v=home2',
  logoOfficialUrl: '/branding/pinebloom-logo-official.png?v=home2',
  logoSidebarUrl: '/branding/pinebloom-logo-sidebar.png?v=home2',
  logoMobileUrl: '/branding/pinebloom-logo-official.png?v=home2',
  ...
  watermarkUrl: '/branding/pinebloom-field-hero.png?v=home2',
  landscapeUrl: '/branding/pinebloom-field-hero.png?v=home2',
