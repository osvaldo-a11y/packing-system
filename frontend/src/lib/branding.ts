...
export const appBranding: AppBranding = {
  ...
  logoUrl: envLogo?.trim() || '/branding/pinebloom-logo-official.png?v=home1',
  logoFullUrl: '/branding/pinebloom-logo-official.png?v=home1',
  logoOfficialUrl: '/branding/pinebloom-logo-official.png?v=home1',
  logoSidebarUrl: '/branding/pinebloom-logo-sidebar.png?v=home1',
  logoMobileUrl: '/branding/pinebloom-logo-official.png?v=home1',
  ...
  watermarkUrl: '/branding/pinebloom-field-hero.png?v=home1',
  landscapeUrl: '/branding/pinebloom-field-hero.png?v=home1',
