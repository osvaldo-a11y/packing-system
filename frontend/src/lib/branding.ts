...
export const appBranding: AppBranding = {
  ...
  logoUrl: envLogo?.trim() || '/branding/pinebloom-logo-official.png?v=home3',
  logoFullUrl: '/branding/pinebloom-logo-official.png?v=home3',
  logoOfficialUrl: '/branding/pinebloom-logo-official.png?v=home3',
  logoSidebarUrl: '/branding/pinebloom-logo-sidebar.png?v=home3',
  logoMobileUrl: '/branding/pinebloom-logo-official.png?v=home3',
  ...
  watermarkUrl: '/branding/pinebloom-field-hero.png?v=home3',
  landscapeUrl: '/branding/pinebloom-field-hero.png?v=home3',
