...
export const appBranding: AppBranding = {
  ...
  logoUrl: envLogo?.trim() || '/branding/pinebloom-logo-official.png?v=home8',
  logoFullUrl: '/branding/pinebloom-logo-official.png?v=home8',
  logoOfficialUrl: '/branding/pinebloom-logo-official.png?v=home8',
  logoSidebarUrl: '/branding/pinebloom-logo-sidebar.png?v=home8',
  logoMobileUrl: '/branding/pinebloom-logo-official.png?v=home8',
  ...
  watermarkUrl: '/branding/pinebloom-field-hero.png?v=home8',
  landscapeUrl: '/branding/pinebloom-field-hero.png?v=home8',
