...
export const appBranding: AppBranding = {
  ...
  logoUrl: envLogo?.trim() || '/branding/pinebloom-logo-official.png?v=home5',
  logoFullUrl: '/branding/pinebloom-logo-official.png?v=home5',
  logoOfficialUrl: '/branding/pinebloom-logo-official.png?v=home5',
  logoSidebarUrl: '/branding/pinebloom-logo-sidebar.png?v=home5',
  logoMobileUrl: '/branding/pinebloom-logo-official.png?v=home5',
