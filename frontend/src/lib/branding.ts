...
export const appBranding: AppBranding = {
  ...
  logoUrl: envLogo?.trim() || '/branding/pinebloom-logo-official.png?v=home4',
  logoFullUrl: '/branding/pinebloom-logo-official.png?v=home4',
  logoOfficialUrl: '/branding/pinebloom-logo-official.png?v=home4',
  logoSidebarUrl: '/branding/pinebloom-logo-sidebar.png?v=home4',
  logoMobileUrl: '/branding/pinebloom-logo-official.png?v=home4',
  ...
  watermarkUrl: '/branding/pinebloom-field-hero.png?v=home4',
  landscapeUrl: '/branding/pinebloom-field-hero.png?v=home4',
