...
export const appBranding: AppBranding = {
  ...
  logoUrl: envLogo?.trim() || '/branding/pinebloom-logo-official.png?v=fid4',
  logoFullUrl: '/branding/pinebloom-logo-official.png?v=fid4',
  logoOfficialUrl: '/branding/pinebloom-logo-official.png?v=fid4',
  logoSidebarUrl: '/branding/pinebloom-logo-sidebar.png?v=fid4',
  logoMobileUrl: '/branding/pinebloom-logo-official.png?v=fid4',
  ...
  watermarkUrl: '/branding/pinebloom-field-hero.png?v=fid4',
  landscapeUrl: '/branding/pinebloom-field-hero.png?v=fid4',
