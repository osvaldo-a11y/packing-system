...
export const appBranding: AppBranding = {
  ...
  logoUrl: envLogo?.trim() || '/branding/pinebloom-logo-official.png?v=home7',
  logoFullUrl: '/branding/pinebloom-logo-official.png?v=home7',
  logoOfficialUrl: '/branding/pinebloom-logo-official.png?v=home7',
  logoSidebarUrl: '/branding/pinebloom-logo-sidebar.png?v=home7',
  logoMobileUrl: '/branding/pinebloom-logo-official.png?v=home7',
  ...
  watermarkUrl: '/branding/pinebloom-field-hero.png?v=home7',
  landscapeUrl: '/branding/pinebloom-field-hero.png?v=home7',
