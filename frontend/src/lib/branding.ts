...
export const appBranding: AppBranding = {
  ...
  logoUrl: envLogo?.trim() || '/branding/pinebloom-logo-official.png?v=fid2',
  logoFullUrl: '/branding/pinebloom-logo-official.png?v=fid2',
  logoOfficialUrl: '/branding/pinebloom-logo-official.png?v=fid2',
  logoSidebarUrl: '/branding/pinebloom-logo-sidebar.png?v=fid2',
  logoMobileUrl: '/branding/pinebloom-logo-official.png?v=fid2',
  ...
  watermarkUrl: '/branding/pinebloom-field-hero.png?v=fid2',
  landscapeUrl: '/branding/pinebloom-field-hero.png?v=fid2',
