...
| `demo` (usuario) | En **producción**: rol `viewer` (solo lectura). En **sandbox** (`DEMO_SANDBOX=true`, BD aparte): rol escribible (`admin` por defecto) para que un prospecto cargue datos. Ver [docs/DEMO-SANDBOX.md](docs/DEMO-SANDBOX.md). |
