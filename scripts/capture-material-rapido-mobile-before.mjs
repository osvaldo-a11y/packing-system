...
const OUT = process.argv[2] || '/opt/cursor/artifacts/material-rapido-mobile/before';
...

{
  ...
  await page.waitForTimeout(500);
  await shot(page, 'A_material_rapido_desktop.png');
  await page.close();
}

{
  ...
  await shot(page, 'D_nuevo_despacho_mobile.png');
  await page.goto(`${base}/#/pt-tags`, { waitUntil: 'networkidle' });
  await page.waitForTimeout(800);
  await openFiberDialog(page);
  await shot(page, 'E_nueva_unidad_pt_mobile.png');
  await page.close();
}
