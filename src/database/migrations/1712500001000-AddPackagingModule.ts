...
export class AddPackagingModule1712500001000 implements MigrationInterface {
  name = 'AddPackagingModule1712500001000';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE material_category AS ENUM ('clamshell','caja','etiqueta','tape','corner_board','otro')`,
    );
